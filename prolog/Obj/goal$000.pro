...
clauses
	...
	/*seleccionar caja de pila para meter en otra pila*/
	muevecaja(estado(LBOX,ALMACENi),estado(LBOX,ALMACENf)):-
		sacadepila(BOX,ALMACENi,ALMACENtmp),
		colocaenpila(BOX,ALMACENtmp,ALMACENf).
