...
(format t "~%TEST:sustitution_test.lsp: constant: (sustitution ~S ~S): ~S (expected: Y)" test_sustitution_var_first test_sustitution_var_second test_sustitution_var_result)
