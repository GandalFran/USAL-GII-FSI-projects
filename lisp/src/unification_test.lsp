...
(test_unification "test 00" '(F (? X) (G (? X)))  '(F (? A) (G (? B)) )  '(((? B) (? X)) ((? B) (? A))) )
(test_unification "test 01" '(F (? X) (G (? X) )) '(F A (G A))           '(A (? X))                     )
(test_unification "test 02" '(G (? X) A)          '(G (M N) (? y))       '(((M N) (? X)) (A (? Y)))     )
(test_unification "test 03" '(FRUTA MANZANA)      '(FRUTA (? x))         '(MANZANA (? X))               )
(test_unification "test 04" '(A B C D)            '(X Y Z Z)             'UNIFICATION_ERROR             )