...
(format t "~%INFO:unification_test.lsp: constant: (unification ~S ~S) = ~S (expected: ( ((F H) (? X)) (A (? Y))) )" test_unification_var_first test_unification_var_second test_unification_var_result)
