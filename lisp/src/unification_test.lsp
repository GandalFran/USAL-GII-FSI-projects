...
(test_unification "test 6"  '( PARENTS (? x) (FATHER (? x)) (MOTHER BILL) ) '( PARENTS BILL (FATHER BILL) (? y) ) ' ( (BILL (? x)) ((MOTHER BILL) (? Y)) ) )
...
;ERROR -> (test_unification "test 11" '((? x) B) '(A (? y)) '((A (? X)) (B (? Y))) )
;ERROR -> (test_unification "test 12" '((? x) B (? x) A) '(A (? y) (? x) A) '( (A (? X)) (B (? Y))) )
;ERROR -> (test_unification "test 13" '(P M (? x) B) '(P M  A (? y)) '( (A (? X)) (B (? Y)) ) )
