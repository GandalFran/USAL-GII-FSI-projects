...
;(test_unification "test 14" '(P (? x) B (? c)) '(P A (? y) (f A)) '((A (? X)) (B (? Y)) ((F A) (? C))) )
;(test_unification "test 15" '(P (? x) B (? c)) '(P A (? y) (f A B)) '( (A (? X)) (B (? Y)) ((F A B) (? C)))  )
;(test_unification "test 16" '(P (? x) B (? c)) '(P A (? y) (f A B)) '( (A (? X)) (B (? Y)) ((F A B) (? C))) )
